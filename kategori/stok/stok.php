...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        /* STYLE MINIMALIS UNTUK ACTION BOX KOTAK (GAMBAR 2) */
        .action-box-group {
            display: inline-flex;
            align-items: center;
            background: #f8fafc;
...
<div class="sidebar">
    ...
    <div class="dropdown-container" style="display: block;">
        <a href="/monitoring_barang/kategori/stok/stok.php" class="active-menu">Stok</a>
            ...
            <table class="table-cyber">
                <thead>
                    <tr>
                        ...
                        <th width="110">JUMLAH STOK</th>
                        <th width="110">NOMOR RAK</th>
                        <th width="120">STATUS KONDISI</th>
