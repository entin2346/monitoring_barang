...
if(isset($_POST['simpan'])){
    ...
    $query = "INSERT INTO peminjaman (nama_material, asal_material, tanggal_pengambilan, peminjam, jumlah, satuan, status_kembali, jumlah_dikembalikan, link_ba_ambil, link_ba_kembali, dokumentasi, keterangan) 
              VALUES ('$nama_material', '$asal_material', '$tanggal_pengambilan', '$peminjam', '$jumlah', '$satuan', '$status_kembali', '$jumlah_dikembalikan', '$link_ba_ambil', '$link_ba_kembali', '$dokumentasi_json', '$keterangan')";
    
    if(mysqli_query($conn, $query)){
        echo "<script>alert('Data peminjaman berhasil ditambahkan!'); window.location='peminjaman.php';</script>";
    } else {
...
<head>
    ...
    <title>I-CALM | Tambah Peminjaman</title>
...
<div class="content">
    <nav class="navbar navbar-custom">
        <div class="container-fluid px-0">
            <span class="navbar-brand mb-0 h1 d-flex align-items-center">
                ...
                <span class="ms-2 fw-normal" style="font-size: 0.95rem; color: var(--text-muted);">/ Kategori: Peminjaman / Tambah Data</span>
            </span>
        </div>
    </nav>
    ...
    <div class="main-body-wrapper">
        <div class="glass-card">
            <h4 class="fw-bold mb-4" style="color: #0f172a;"><i class="fa-solid fa-circle-plus text-success me-2"></i>Form Tambah Peminjaman Material</h4>
            
            <form method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">Material (Nama Material)</label>
                        <input type="text" name="nama_material" class="form-control" placeholder="Masukkan nama material..." required autocomplete="off">
                    </div>
                    
                    <div class="col-md-6">
                        <label class="form-label">Asal Material</label>
                        <input type="text" name="asal_material" class="form-control" placeholder="Masukkan asal material..." autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="jumlah_dikembalikan" class="form-control" placeholder="Isi 0 jika belum ada yang kembali" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12">
                        <label class="form-label">Unggah Dokumentasi (Beberapa Foto / File Berkas)</label>
                        ...
                        <div class="form-text text-muted" style="font-size: 0.75rem;">Anda dapat memilih lebih dari satu file foto (jpg, png) atau dokumen lainnya sekaligus.</div>
                    </div>

                    <div class="col-md-12">
                        <label class="form-label">Keterangan</label>
                        <textarea name="keterangan" class="form-control" rows="3" placeholder="Masukkan catatan opsional atau rincian tambahan di sini..."></textarea>
                    </div>
                </div>
                
                <div class="mt-4 gap-2 d-flex">
                    <button type="submit" name="simpan" class="btn btn-success px-4 fw-bold" style="border-radius:10px; background: linear-gradient(135deg, #10b981, #059669); border:none;"><i class="fa-solid fa-floppy-disk me-1"></i> Simpan Data</button>
