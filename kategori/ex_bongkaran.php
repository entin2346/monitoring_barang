...
// Ambil data dari database dengan offset LIMIT yang benar dan aman
                ...
                <div class="row g-3">
                    <div class="col-md-10">
                        <div class="input-group input-cyber-group">
                            ...
                            <input type="text" name="cari" class="form-control" autocomplete="off" placeholder="Cari material..." value="<?= htmlspecialchars($cari_clean); ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
        ...
        <div class="cyber-table-wrapper mb-4">
            <table class="table-cyber">
                ...
                <tbody>
                    ...
                    <?php } } else { ?>
                    <tr>
                        <td colspan="42" class="text-center py-5" style="color: var(--text-muted) !important;">
