...
<div class="sidebar">
    ...
    <div class="dropdown-container" style="display: block;">
        ...
        <a href="peminjaman.php" class="active-menu">Peminjaman</a>
...
<div class="content">
    <nav class="navbar navbar-custom">
        <div class="container-fluid px-0">
            <span class="navbar-brand mb-0 h1"><i class="fa-solid fa-boxes-stacked text-primary me-2"></i> KENDALI LOGISTIK / Kategori: Peminjaman</span>
        </div>
    </nav>
    ...
    <div class="main-body-wrapper">
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6"><div class="glass-stat-card" style="border-left-color: #f59e0b;"><div class="stat-label">Total Volume Peminjaman</div><div class="stat-number" style="color: #f59e0b;"><?= number_format($total_stok); ?></div></div></div>
        </div>
