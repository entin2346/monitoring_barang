...
// KUNCI FILTER: Hanya menarik data kategori NON STOK / NON STOCK
$whereClause = "(jenis_kategori LIKE '%non%stok%' OR jenis_kategori LIKE '%non%stock%')";
if ($cari_clean !== '') {
            ...
            <table class="table-cyber">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge-kat kat-nonstock">Non Stok</span></td>
