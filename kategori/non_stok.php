                ...
                <tbody>
                    ...
                    if(mysqli_num_rows($query) > 0){
                        while($d = mysqli_fetch_assoc($query)){
                            // Cek status kecocokan Non Stok (ID > 63 atau teks mengandung kata 'non')
                            $is_nonstock = ((int)$d['id'] > 63 || strpos(strtolower($d['jenis_kategori'] ?? ''), 'non') !== false);
                    ?>
                    <tr>
                        ...
                        <td>
                            <?php if($is_nonstock) { ?>
                                <span class="badge-kat kat-nonstock">Non Stok</span>
                            <?php } else { ?>
                                <span class="badge-kat kat-other"><?= htmlspecialchars($d['jenis_kategori'] ?: '-'); ?></span>
                            <?php } ?>
                        </td>
