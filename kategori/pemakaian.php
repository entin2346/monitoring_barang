...
// Kunci filter untuk kategori PEMAKAIAN
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .kat-pemakaian { background: #dcfce7; color: #15803d; border: 1px solid #bbf7d0; } /* Warna Hijau */
    </style>
</head>
<body>
...
<div class="content">
    <nav class="navbar navbar-custom">
        <div class="container-fluid px-0">
            <span class="navbar-brand mb-0 h1"><i class="fa-solid fa-boxes-stacked text-primary me-2"></i> KENDALI LOGISTIK / Kategori: Pemakaian</span>
        </div>
    </nav>
    ...
    <div class="main-body-wrapper">
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6"><div class="glass-stat-card" style="border-left-color: #10b981;"><div class="stat-label">Total Volume Pemakaian</div><div class="stat-number" style="color: #10b981;"><?= number_format($total_stok); ?></div></div></div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-10">
                        <div class="input-group input-cyber-group">
                            ...
                            <input type="text" name="cari" class="form-control" placeholder="Cari nama material di kategori Pemakaian..." value="<?= htmlspecialchars($cari_clean); ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <table class="table-cyber">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge-kat kat-pemakaian">Pemakaian</span></td>
                        <td><?= htmlspecialchars($d['satuan']); ?></td>
                        <td><span class="badge bg-success px-3 py-2"><?= number_format($d['jumlah']); ?></span></td>
