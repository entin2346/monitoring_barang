    ...
    if (isset($_FILES['file_csv']) && $_FILES['file_csv']['error'] == 0) {
        ...
        if (($handle = fopen($filename, "r")) !== FALSE) {
            ...
            while (($row = fgetcsv($handle, 10000, ",")) !== FALSE) {
                ...
                // Tanda pengunci jenis kategori halaman otomatis menjadi stok
                $jenis_kategori     = 'stok'; 
            ...
            echo "<script>alert('Berhasil mengimport $sukses_insert data CSV Stok! Gagal: $gagal_insert'); window.location='../kategori/stok.php';</script>";
            exit;
        } else {
...
<div class="sidebar">
    ...
    <div class="dropdown-container" style="display: block;">
        ...
        <a href="form_stok.php" class="active-sub">Import Stok</a>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="cyber-card">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="../kategori/stok.php" class="btn btn-light w-100 fw-bold py-2" style="border-radius: 12px; border: 1px solid #cbd5e1;">
