...
<head>
    ...
    <title>I-CALM | Import Material Gudang</title>
    ...
    <nav class="navbar navbar-custom">
        <div class="container-fluid px-0">
            <span class="navbar-brand mb-0 h1 d-flex align-items-center">
                ...
                <span class="ms-2" style="font-weight: 400; font-size: 0.95rem; color: var(--text-muted);">/ Bulk Import Data Material</span>
            </span>
        </div>
    </nav>
