...
// 2. PROSES BACKEND CSV PEMAKAIAN
    ...
    if (isset($_FILES['file_csv']) && $_FILES['file_csv']['error'] == 0) {
        ...
        if (($handle = fopen($filename, "r")) !== FALSE) {
            ...
            while (($row = fgetcsv($handle, 10000, ",")) !== FALSE) {
                ...
                $jumlah_terpakai    = mysqli_real_escape_string($conn, $row[4] ?? 0);   // Kolom E: JUMLAH TERPAKAI
                $no_rak             = mysqli_real_escape_string($conn, $row[5] ?? '');  // Kolom F: NOMOR RAK
                
                // Tanda pengunci jenis kategori halaman otomatis menjadi pemakaian
                $jenis_kategori     = 'pemakaian'; 
                ...
                $query = "INSERT INTO material_gudang 
                          ...
                          VALUES 
                          ('$nama_material', '$kategori_asal', '$satuan', '$jumlah_terpakai', '$no_rak', '$jenis_kategori')";
            ...
            echo "<script>alert('Berhasil mengimport $sukses_insert data CSV Pemakaian! Gagal: $gagal_insert'); window.location='../kategori/pemakaian.php';</script>";
            exit;
        } else {
...
// 3. AMBIL STATISTIK UNTUK TAMPILAN INFORMASI HALAMAN PEMAKAIAN
$q_pemakaian = mysqli_query($conn, "SELECT COUNT(*) as total_pemakaian FROM material_gudang WHERE jenis_kategori = 'pemakaian'");
$res_pemakaian = mysqli_fetch_assoc($q_pemakaian);
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="sidebar">
    ...
    <div class="dropdown-container" style="display: block;">
        ...
        <a href="form_pemakaian.php" class="active-sub">Import Pemakaian</a>
    </div>
                ...
                <div class="cyber-card">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h5 class="fw-bold m-0" style="color: var(--text-main);">
                            <i class="fa-solid fa-upload text-primary me-2"></i> Import CSV - Pemakaian
                        </h5>
                        <span class="badge bg-info text-dark fw-bold px-3 py-2" style="border-radius: 8px;">
                            Total Data: <?= number_format($res_pemakaian['total_pemakaian']); ?> Item
                        </span>
                    </div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-4">
                            <label class="form-label fw-bold small text-muted text-uppercase mb-2">Pilih File CSV Master Pemakaian</label>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="../kategori/pemakaian.php" class="btn btn-light w-100 fw-bold py-2" style="border-radius: 12px; border: 1px solid #cbd5e1;">
