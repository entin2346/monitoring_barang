                    ...
                    <div class="col-md-6">
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <?php
                                $kat = strtolower(trim($data['jenis_kategori'] ?? ''));
                                if($kat == 'stok' || $kat == 'material stock'){
                                    ...
                                    echo '<span class="badge-kat kat-prememory">' . htmlspecialchars($data['jenis_kategori'] ?: '-', ENT_QUOTES, 'UTF-8') . '</span>';
                                }
                                ?>
                            </div>
                        </div>
