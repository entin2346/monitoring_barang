...
<style>
    ...
    * {
    ...
    /* JUDUL MATERIAL KELUAR YANG SUPER TEBAL & MENCOLOK (GLOWING FLAMBOYAN) */
            ...
            <table class="table-cyber">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center col-nowrap"><span class="badge bg-danger-subtle text-danger border-0 px-2 py-0.5" style="border-radius:4px; font-size:0.75rem; font-weight:600;"><?= htmlspecialchars($d['kategori_material'] ?? ''); ?></span></td>
